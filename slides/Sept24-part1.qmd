...
## Claude Code and Pi {.compare .band-bottom}
...
In lab803, the five Northwind spreadsheets are in `data/`. Elsewhere, download [northwind.zip](../files/Sept24-part1/northwind.zip){download="northwind.zip"}.
